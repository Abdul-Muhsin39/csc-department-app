...
const faculty = [
  {
    id: 1,
    name: "Prof.Abdul Barik Alhassan",
    title: "Head of Department",
    email: "ballhassan@uds.university.edu.gh",
    phone: "(233) 123-4567",
    office: "Faculty of Physical Sciences, Room 301",
    officeHours: "Monday & Wednesday: 2:00 PM - 4:00 PM",
    research: "Artificial Intelligence, Machine Learning",
    bio: "Prof.Abdul Barik Alhassan has been with the department for over 15 years. His research focuses on machine learning algorithms and their applications in healthcare. He has published numerous articles in top journals and has received grants from the National Science Foundation.",
    courses: ["CSC510: Machine Learning", "CSC101: Introduction to Programming"],
    image: "/placeholder.svg"
  },
  {
    id: 2,
    name: "Dr.Tandoh Laurence",
    title: "Examination Officer",
    email: "tlaurence@uds.university.edu.gh",
    phone: "(86)183-989-74393",
    office: "Faculty of Physical Sciences, Room 302",
    officeHours: "Tuesday & Thursday: 1:00 PM - 3:00 PM",
    research: "Computer Graphics, Virtual Reality",
    bio: "Dr.Tandoh Laurence joined the department in 2015 after completing her postdoctoral research at MIT. Her work in computer graphics has contributed to advancements in virtual reality applications for education and training.",
    courses: ["CSC315: Web Development", "CSC401: Computer Graphics"],
    image: "/placeholder.svg"
  },
  {
    id: 3,
    ...
    email: "salhassan@uds.university.edu.gh",
    phone: "(233) 123-4569",
    office: "Faculty of Physical Sciences, Room 303",
    ...
    courses: ["CSC225: Algorithms", "CSC330: Cybersecurity"],
    image: "/placeholder.svg"
  },
  {
    id: 4,
    name: "Abdul-Wakil Yakubu Iddrisu ",
    title: "MPhil",
    email: "abdulwakil.iddi@gmail.com",
    phone: "(233) 24-813-7800",
    office: "Faculty of Physical Sciences, Room 304",
    ...
    courses: ["CSC306: Mobile Device Programming", "CSC402: Human-Computer Interaction"],
    image: "/placeholder.svg"
  }
];
